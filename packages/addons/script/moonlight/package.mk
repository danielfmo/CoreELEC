...
addon() {
  ...
  mkdir -p $ADDON_BUILD/$PKG_ADDON_ID/lib
    ...
    #cp $(get_build_dir moonlight-embedded)/.$TARGET_NAME/libgamestream/libgamestream.so.4 $ADDON_BUILD/$PKG_ADDON_ID/lib
    #cp $(get_build_dir moonlight-embedded)/.$TARGET_NAME/libgamestream/libgamestream.so $ADDON_BUILD/$PKG_ADDON_ID/lib
    cp $(get_build_dir moonlight-embedded)/.$TARGET_NAME/libgamestream/libmoonlight-common.so.2.4.6 $ADDON_BUILD/$PKG_ADDON_ID/lib
    #cp $(get_build_dir moonlight-embedded)/.$TARGET_NAME/libgamestream/libmoonlight-common.so.4 $ADDON_BUILD/$PKG_ADDON_ID/lib
    #cp $(get_build_dir moonlight-embedded)/.$TARGET_NAME/libgamestream/libmoonlight-common.so $ADDON_BUILD/$PKG_ADDON_ID/lib
